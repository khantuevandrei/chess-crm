    ...
    public function index()
    {
        ...
        return Inertia::render('Trainers/Index', [
            ...
            'stats' => [
                ...
                ['title' => 'Lessons', 'value' => Lesson::whereBetween('start_time', [now()->startOfWeek(), now()->endOfWeek()])->count(), 'change' => 'Scheduled this week', 'icon' => 'pi pi-calendar-clock', 'color' => 'yellow', 'positive' => false],
